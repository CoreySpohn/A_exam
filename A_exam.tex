...
\tikzoverlay[text width = 5cm] at (3cm, 1.85cm){
    \includegraphics[width=7cm]{ForecasterMod.png}
};
\footlineextra{\textcite{Savransky2019SPIE}}
}
...
%\tikzoverlay[text width = 10cm] at (0cm-3pt, 3.1cm+4.5pt){
    %\animategraphics[loop, controls, width=14cm]{10}{ML_vis/frame-}{0}{99}
%};
}
...
%\tikzoverlay[text width = 10cm] at (0cm-3pt, 3.1cm+4.5pt){
    %\animategraphics[loop, controls, width=14cm]{10}{MKDE_vis/frame-}{0}{99}
%};
}
...
%\tikzoverlay[text width = 10cm] at (0cm-3pt, 3.1cm+4.5pt){
    %\animategraphics[loop, controls, width=14cm]{10}{CI_vis/frame-}{0}{99}
%};
}
...
\frame{
    ...
    \tikzoverlay[text width=10cm] at (-.3cm, 1.5cm){
...
%\tikzoverlay[text width = 10cm] at (0cm-3pt, 3.1cm+4.5pt){
    %\animategraphics[loop, controls, width=14cm]{10}{MG_vis/frame-}{0}{99}
%};
}
...
\tikzoverlay[text width = 10cm] at (1cm-3pt, 2.2cm+4.5pt){
    \animategraphics[loop, controls, width=10cm]{10}{ratio_example/frame-}{98}{99}
...
\tikzoverlay[text width = 10cm] at (0cm-3pt, 3.1cm+4.5pt){
    \animategraphics[loop, controls, width=14cm]{50}{CI_if/ratio-0.50-frame-}{0}{364}
};
}
\frame{
...
\tikzoverlay[text width = 14cm] at (0cm, 3cm+4.5pt){
    \animategraphics[controls, width=14cm]{50}{ML_if/ratio-0.50-frame-}{0}{364}
};
}
...
\begin{itemize}
    \item[\textbullet] Run simulations with more realistic photometry
        \begin{enumerate}
            \item[1)] Classify planets using Kopparapu bins
        ...
        \end{enumerate}
\end{itemize}
\footlineextra{\textcite{Kopparapu2018b}, \textcite{Batalha2018a},}
}

\frame{
\frametitle{Precursor RV target optimization and validation}
\begin{itemize}
    \item[\textbullet] Create SimulatedUniverse module that provides synthetic RV data that can be
        fitted with RadVel
