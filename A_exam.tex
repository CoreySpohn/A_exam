...
\tikzoverlay[text width = 6cm] at (1cm, 3cm+4.5pt){
    \animategraphics[loop, controls, width=12cm]{20}{mass_inclination_comparision/frame-}{0}{99}
};
}
%\frame{
    %\frametitle{Impact on direct imaging: geometric constraint}
%\tikzoverlay[text width = 6cm] at (-1cm, 3cm+4.5pt){
    %\animategraphics[loop, controls, width=12cm]{20}{geometric_detection_criteria/frame-}{0}{99}
%};
%}
%\frame{
    %\frametitle{Impact on direct imaging: photometric constraint}
%\tikzoverlay[text width = 6cm] at (1cm, 3cm+4.5pt){
    %\animategraphics[loop, controls, width=12cm]{20}{photometric_detection_criteria/frame-}{0}{99}
%};
%}
