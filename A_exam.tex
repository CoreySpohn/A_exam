...
\tikzoverlay[text width = 6cm] at (0.5cm, 3cm+4.5pt){
    \animategraphics[loop, controls, width=6cm]{5}{edge_on_orbit/frame-}{0}{30}
};
\tikzoverlay[text width = 6cm] at (7.5cm-3pt, 3cm+4.5pt){
    \animategraphics[loop, controls, width=6cm]{5}{face_on_orbit/frame-}{0}{30}
};
\tikzoverlay[text width = 14cm] at (0cm, -1cm+4.5pt){
\begin{itemize}
    \item How should we use the incomplete RV information to predict when a planet is detectable
    \item How long will fitted orbital parameters accurately predict the planet’s location?
\end{itemize}
};
}
