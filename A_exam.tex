...
\tikzoverlay[text width = 8cm] at (0cm, 2.65cm){
\begin{itemize}
...
\tikzoverlay[text width = 5cm] at (8.15cm, 2.65cm){
    \animategraphics[loop, width=4cm]{10}{figures/HR_8799_gif/HR_8799-}{0}{6}
};
}

\frame{
\frametitle{Optimizing Observations}
\begin{itemize}
    \item Simulating missions (EXOSIMS)
    \item Completeness
    \item Precursor measurements
\end{itemize}
}
...
\includegraphics[width=\paperwidth,clip=true,trim= 0in 0in 0in 0in]{template/labgroup2021}
}
...
\BackgroundPicture{template/labgroup2021}{1}{0.78} %need to match to image aspect ratio.  these are fractions of 16:9
\frame[plain]{}
